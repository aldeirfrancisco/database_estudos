...
public class CategoriaResource {
	...
	public ResponseEntity<Void> insert(@Valid @RequestBody  CategoriaDTO objDTO){//coverte o json para objeto java, @Valid valida antes de passa o objeto 
	...
	public ResponseEntity<Page<CategoriaDTO>> findPage(
		...
		Page<CategoriaDTO> listDTO = list.map(obj -> new CategoriaDTO(obj));//convertendo a page Categoria para DTO
		return ResponseEntity.ok().body(listDTO) ;
	}
}
